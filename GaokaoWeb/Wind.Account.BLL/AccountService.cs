    ...
    public class AccountService : IAccountService
    {
        ...
        public Guid SaveVerifyCode(string verifyCodeText)
        {
            ...
            using (var dbContext = new AccountDbContext())
            {
                ...
                //dbContext.Set<VerifyCode>().Add(verifyCode);
                //dbContext.SaveChanges();
        ...
        public bool CheckVerifyCode(string verifyCodeText, Guid guid)
        {
            using (var dbContext = new AccountDbContext())
            {
                ...
                if (verifyCode != null)
                {
                    ...
                    foreach (var item in dbContext.VerifyCodes.Where(v=>v.CreateTime<expiredTime)) {
                        dbContext.Entry<VerifyCode>(item).State=System.Data.Entity.EntityState.Deleted;
                    }
                    dbContext.SaveChanges();
